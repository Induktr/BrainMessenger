...
- Name: Authentication Flow >> should refresh access token using refresh token when access token expires
- Location: /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:37:7
...
Call log:
  - navigating to "http://localhost:3000/login", waiting until "load"
    ...
    at /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:44:16
```
