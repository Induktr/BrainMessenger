...
- Name: should redirect to chat page if valid tokens are present in localStorage on visiting root
- Location: /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:203:5
...
Call log:
  - navigating to "http://localhost:3000/login", waiting until "load"
    ...
    at /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:205:14
```
