...
- Name: Authentication Flow >> should maintain authentication state after page reload if tokens are valid
- Location: /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:82:7
...
Call log:
  - navigating to "http://localhost:3000/login", waiting until "load"
    ...
    at /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:84:16
```
