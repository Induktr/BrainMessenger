...
- Name: Authentication Flow >> should navigate to the login page
- Location: /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:5:7
...
Call log:
  - navigating to "http://localhost:3000/login", waiting until "load"
    ...
    at /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:7:16
```
