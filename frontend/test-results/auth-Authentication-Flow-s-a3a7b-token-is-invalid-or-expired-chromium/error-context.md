...
- Name: Authentication Flow >> should redirect to login page if refresh token is invalid or expired
- Location: /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:100:7
...
Call log:
  - navigating to "http://localhost:3000/login", waiting until "load"
    ...
    at /home/induktr/Storage/Projects/BrainMessenger/frontend/e2e/auth.spec.ts:106:16
```
