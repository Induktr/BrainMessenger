...
// The config you add here will be used whenever a page is rendered.
...
Sentry.init({
  ...
  // Setting this to true will print useful information to the console while you're setting up Sentry.
  debug: false,
